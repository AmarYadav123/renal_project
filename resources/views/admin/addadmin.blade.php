...
<div class="card">
    <div class="card-header">
        <a href="" class="btn btn-info" style="float: right;" data-toggle="modal" data-target="#zz">Add Admin</a>
...
<!-- Button trigger modal -->
  <div class="modal-body">
      <form method="post" action="{{url('admin_insert')}}" enctype="multipart/form-data">
        @csrf
